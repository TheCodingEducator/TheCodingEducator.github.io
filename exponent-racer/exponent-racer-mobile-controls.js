...
(function () {
  ...
  style.textContent =
    ...
    // full-width bottom strip even on the start/shop/results screens,
    // where the joystick isn't needed and the standards panel/teaching
  ...
  // ---- Show the joystick/action bar only while actually driving - not
  // on the start/skill-select/shop menus or the game-over/win screens,
  // where the joystick does nothing and this full-width strip would
  // otherwise block reaching the standards panel/teaching notes below
  // the fold. ----
  function refreshVisibility() {
    var show = typeof gameState !== 'undefined' && (gameState === 'play' || gameState === 'paused');
